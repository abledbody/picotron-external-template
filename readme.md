...
This template is designed to be used with [Sumneko's Lua language server extension](https://luals.github.io/) for VSCode, and the [Lua Comments And Type System (LuaCATS) annotations](https://luals.github.io/wiki/annotations/) it provides.
